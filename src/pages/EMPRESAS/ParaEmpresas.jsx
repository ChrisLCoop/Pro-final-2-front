...
import Box17Img3 from "../../assets/img-empresas/gestao-de-risco-01.jpg"
import Box17Img4 from "../../assets/img-empresas/rh-5-0-01.jpg"
  ...
  return (
    <div className='cont-para-empresas-tlf'>
        ...
        <div class="menu1-cabezal">
          <nav>
            <ul>
              <li><Link href="">NUESTROS CURSOS</Link></li>
              <li><a href="">SOLUCIONES</a></li>
              <li><a href="">CONTENIDOS</a></li>
              <li><a href="">ECOSISTEMA</a></li>
              <li><a href="">PLANES</a></li>
              <li><a href="">CONTACTO</a></li>
              <button><a href="">SOLICITAR PRESUPUESTO</a></button>
      ...
      <section>
          <div class="caja-empresa1">
              <div class="caja-empresa-letras">
              <h2 class="letra1-empresa">Preparando talentos en<br/>
                  tecnología para el futuro de los<br/> negocios.</h2>
              <br/>
          ...
          <div class="container-empresa3">
              <div class="fondo-empresa3">
              <div class="caja1-empresa3">
                <div class="titulo1-empresa3">
                  <h3>Capacitación<br/> <b>en tecnología</b></h3>
                </div>
                <div class="contenido1-empresa3">
                  <h4>¿Sus equipos dominan las últimas tecnologías? Desde principiantes hasta seniors, capacitamos a sus equipos en las habilidades tecnológicas duras y blandas más demandadas. Prepare a su gente para los cambios y desafíos de un mercado en continua transformación.</h4>
                </div>
              </div>
              </div>
              
              <div class="fondo2-empresa3">
              <div class="caja2-empresa3">
                  <div class="titulo2-empresa3">
                      <h3>Desarrollo<br/> <b>de líderes</b></h3>
                  </div>
                  <div class="contenido1-empresa3">
                      <h4>Su gestión necesita liderar equipos de alto rendimiento. Desarrollamos tu liderazgo para ser un referente en innovación y gestión de personas. Dé un paso más hacia el logro de los objetivos de crecimiento de su empresa invirtiendo en los talentos de su organización.</h4>
                  </div>
              </div>
              </div>
              
              <div class="fondo3-empresa3">
              <div class="caja3-empresa3">
                  <div class="titulo3-empresa3">
                      <h3>Conocimientos digitales <b>para todos</b></h3>
                  </div>
                  <div class="contenido1-empresa3">
                      <h4>¡La tecnología es para todos! Desde Marketing hasta Finanzas, promueva las habilidades digitales que impulsan los resultados de su empresa. Nuestro contenido integra conocimientos tecnológicos como datos, inteligencia artificial e innovación en todas las áreas de su organización.</h4>
                  </div>
              </div>
              </div>
          </div>
          ...
          <div class="contenedor-boton-conocer">
          <button class="btn-conocer"><h2>QUIERO CONOCER</h2></button>
          </div>

          <div class="caja-empresa5">
              <div class="caja-empresa5-letras">
              <h2 class="letra1-empresa5">Desarrollo de personas<br/>
                  que ayudan a las empresas en<br/> todo momento.</h2>
              <br/>
          ...
          <div class="container-empresa6">
              ...
              <div class="caja1-empresa6">
                  ...
                  <div class="contenido6"><li>
                      ...
                      cultura</b> de la organización.</li></div>
                  <div class="contenido6"><li><b>Mejore la experiencia de los empleados</b>
                      y la marca empleadora.</li></div>
                  <div class="contenido6"><li>Posicionarse como <b>empresa
                      referencia en tecnología.</b></li></div>
              ...
              <div class="caja2-empresa6">
                  ...
                  <div class="contenido6"><li>Prepara tus equipos con
                      incorporación <b>personalizada e inmersiva</b>
                      en tecnología.</li></div>
                  <div class="contenido6"><li><b>Acelera la curva de aprendizaje</b>
                      de nuevos empleados con la
                      Subir de nivel de Alura.</li></div>
                  <div class="contenido6"><li>Crear oportunidades para <b>nuevos
                      talentos</b> con Alura incluyen.</li></div>
              </div>
              ...
              <div class="caja3-empresa6">
                  ...
                  <div class="contenido6"><li><b>Desarrollar personas</b> en Soft
                      Skills y Hard Skills con más de 1470 cursos.</li></div>
                  <div class="contenido6"><li>Fomentar la <b>movilidad interna</b>
                      y aprendizaje continuo.</li></div>
                  <div class="contenido6"><li>Vigile de cerca su
                      <b>Programas de entrenamiento.</b></li></div>
              </div>
              </div>
              </div>
          ...
          <div class="caja-empresa7">
              <div class="letra7-empresa7">
          ...
          <div class="container-empresa8">
              <div class="fondo-empresa8">
              <div class="caja-empresa8">
                  <h3>Mejore las habilidades de equipo<br/>
                      con una solución de aprendizaje completa</h3>
                  <p>Forme a su equipo y siga sus progresos en más de <b>1471 cursos,</b> talleres y podcasts en una única <br/>plataforma</p>
              </div>

              <div class="caja2-empresa8">
                  
                  <div class="letra1-empresa8">
              ...
              <div class="caja4-empresa8">
                  
                  <div class="letra4-empresa8">
              ...
              <div class="ctnr8-empresa8">
              <button class="btn8-empresa8"><h3>HABLE CON NOSOTROS</h3></button>
              </div>
          ...
          <div class="caja-empresa9">
              <div class="caja-empresa9-letras">
              <h2 class="letra1-empresa9">Descubra los programas personalizados de Alura para empresas</h2>
              <br/>
          ...
          <div class="ctnr10-empresa10">
              <div class="box-empresa10">
                  <div class="caja1-empresa10">
                      ...
                      <div class="contenido2-10"><a href=""><h4>Comprender la solución</h4></a></div>
          ...
          <div class="ctnr-empresa11">
              <div class="caja1-empresa11">
                  <div class="titulo-caja1-empresa11"><h3>Impulsando negocios en tecnologia</h3></div>
                  <div class="ctnr-box-all">
                  <div class="box2-empresa11">
                      <div class="texto1-empresa11"><h1>5000+</h1></div>
                      <div class="texto2-empresa11"><h4>Las organizaciones han utilizado Alura Para Empresas para lograr eficiencia e innovación</h4></div>
                  </div>    
                  
                  
                  <div class="box2-empresa11">
                      <div class="texto1-empresa11"><h1>85%</h1></div>
                      <div class="texto2-empresa11"><h4>Los equipos se sienten más productivos y confiados después de Alura Para Empresas</h4></div>
                  </div>
                  
                  <div class="box2-empresa11">
                      <div class="texto1-empresa11"><h1>590K+</h1></div>
                      <div class="texto2-empresa11"><h4>Estudiantes que crecen con nuestros programas de desarrollo</h4></div>
                  </div>
                  </div>
              </div>
          ...
          <div class="ctnr-empresa12">
              <div class="letras1-empresa12">
                  <h2>Transforme su empresa con las<br/> competencias del futuro</h2>
                      
                  <p>Clases prácticas, online, offline y vía app móvil, con contenido 100% en<br/> portugués y enfocadas a lo que el <b>mercado tecnológico necesita</b>.</p>
              </div>
          </div>
          ...
          <div class="ctnr-empresa14">
              <h3>Lo que dicen <br/>los clientes</h3>
              <div class="caja1-empresa14">
                  <div class="caja2-empresa14">
                      <div class="parrafo1-empresa14"><p>Nuestro trabajo en Globo se basa cada vez más en los datos. Los resultados que hemos obtenido con Alura no son diferentes. Dentro de la plataforma Alura, disponemos de un entorno de gestión de participaciones, de gestión de resultados, de gestión de licencias, que nos permite hacer un seguimiento. Nos ayuda en las operaciones cotidianas de gestión y en la difusión de conocimientos.</p></div>
                      <iframe width="480" height="315" src="https://www.youtube.com/embed/QRyDa-twb7U?si=kyHExkkCr7GKE5gZ" title="Video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> 
                  </div>
              </div>

              <div class="ctnr-slider14">
          ...
          <div class="ctnr-empresa15">
              <div class="caja1-empresa15">
                  <h3>Planes</h3>
                  <p>Planes completos y diferenciados <b>para su<br/> estrategia</b> de formación y desarrollo.</p>
                  <div class="caja2-empresa15">
                      <div class="caja3-empresa15">
                          <h2>Corp</h2>
                          ...
                          <button class="btn-empresa15">COMENZAR AHORA</button>
                      </div>
                          ...
                          <div class="caja3-empresa15">
                              ...
                              <button class="btn2-empresa15">SABER MAS</button>
                          </div>
          ...
          <div class="ctnr-empresa16">
              <div class="caja1-empresa16">
                  ...
                  <div class="lista2-empresa16">
                      <div class="inp1-empresa16"><input type="text" placeholder="Nombre*"/></div>
                      <div class="inp1-empresa16"><input type="text" placeholder="E-mail Corporativo*"/></div>
                      <div class="inp1-empresa16"><input type="text" placeholder="Telefono*"/></div>
                      <div class="inp1-empresa16"><input type="text" placeholder="Nombre de la empresa*"/></div>

                      <div class="slt1-empresa16"><select name="" id="">
                          <option>Tamaño de la empresa*</option>
                          <option>11-50 Funcionarios</option>
                          <option>Autonomo</option>
                          <option>2-10 Funcionarios</option>
                          <option>51-200 Funcionarios</option>
                          <option>201-500 Funcionarios</option>
                          <option>1001-5000 Funcionarios</option>
                          <option>5001+ Funcionarios</option>
                      </select></div>
                      
                      <div class="slt2-empresa16"><select name="" id="">
                          <option>Segmento de la empresa*</option>
                          <option>Turismo, Hoteleria , Eventos</option>
                          ...
                          <option>Gobierno, Organos publicos</option>
                      </select></div>
                      <div class="inp1-empresa16"><input type="text" placeholder="Ciudad"/></div>
                      <div class="inp2-empresa16"><input type="text" placeholder="Mensaje"/></div>
                    
                      <div class="check-empresa16">
                          <input type="checkbox" name="my-checkbox" id="opt-in" />
                          <label for="opt-in">Eu li e concordo com a <b><a href="">Política de Privacidade</a></b></label>
                        </div>
                      <button class="btn1-empresa16">ENVIAR MENSAJE</button>
                  </div>
              </div>
          ...
          <div class="ctnr-empresa17">
              <div class="ctnr2-empresa17">
                  <h2>Artigos</h2>
              ...
              <button class="btn-empresa17">VER TODOS LOS ARTICULOS</button>
              </div>
          </div>

          <div class="ctnr-empresa18">
              <div class="letras-empresa18">
          ...
          <footer>
              <div class="ctnr-empresa19">
                  ...
                  <footer>
                      <div class="footer-empresa19">
                          <div class="l1-footer">
                          
                              <div class="titulo1-empresa19"><a href="">EMPRESA</a></div>
                              <a href="">Nosotros</a>
                              <a href="">Contacto</a>
                              <a href="">Faq</a>
                              <a href="">Parcerias</a>
                          ...
                          <div class="l1-footer">
                              ...
                              <div class="titulo1-empresa19"><a href="">SOLUCIONES</a></div>
                              <a href="">Alura Level UP</a>
                              <a href="">Alura Include</a>
                              <a href="">Alura boost</a>
                              <a href="">Plataforma</a>
                          ...
                          <div class="l1-footer">
                              ...
                              <div class="titulo1-empresa19"><a href="">CONTENIDOS</a></div>
                              <a href="">Articulos</a>
                              <a href="">Casos de Exito</a>
                              <a href="">Comunidades</a>
                              <a href="">Guia de Carrera</a>
                              
                          </div>

                          <div class="l1-footer">
                          
                              <div class="titulo1-empresa19"><a href="">MEDIA</a></div>
                              <a href="">En los Medios</a>
                              <a href="">Boletin</a>
